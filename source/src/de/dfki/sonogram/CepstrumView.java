 ...
 * <p>
 * The cepstrum view shows the cepstum transformed vector in a curve form.
 * For the theoretical background of the Cepstrum transformation see the 
 * Sonogram paper at my homepage.
        ...
        public void paintComponent(Graphics gr) {
            ...
            if (refToMain.gad.ccepsmooth.isSelected() == true) {
                ...
                for (int i=3;i<(len-3);i++)
                    cepstrum[i] = (cepstrum[i]+cepstrum[i+1]+cepstrum[i-1]+cepstrum[i+2]+cepstrum[i-2]+cepstrum[i+3]+cepstrum[i-3])/7.0f;
            }
            // Search for Peak
