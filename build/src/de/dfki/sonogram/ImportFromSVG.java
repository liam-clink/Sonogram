   ...
   public ImportFromSVG(Sonogram var1) {
      ...
      while(true) {
         try {
            ...
            if (!var2) {
               this.reftomain.messageBox("No open possible", "SVG file not written by Sonogram.\nNo opening possible", 2);
               return;
            }

            if (var3) {
               this.reftomain.messageBox("No open possible", "SVG file written as PURE SVG\nwith no Sonogram specific Tags.\nNo opening possible.", 2);
               return;
            }
            ...
            if (var4) {
               ...
               var24 = JOptionPane.showOptionDialog(this.reftomain, "If a plot is imported via SVG,\nnot all features of Sonogram are\naviable (zoom,logarithm amplitude...)\nWould you reopen ths File from orginal source ?", "Reopen ?", 0, 3, (Icon)null, (Object[])null, (Object)null);
               if (var24 == 0) {
