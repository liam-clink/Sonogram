...
public class TimerPanel extends javax.swing.JPanel implements java.awt.event.ActionListener, java.awt.event.MouseListener
{    
    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        if (timerRunning == true)
        {
          ...
          if (level > (int)levelPeak)
            levelPeak = (float) level;
          levelPeak -= 0.05;
          if (levelPeak < 0.0f)
            levelPeak = 0.0f;
          if (levelPeak > 15.0f)
    ...
    private java.awt.image.BufferedImage createBackground(int width, int height)
    {
        ...
        {
            new java.awt.Color(0,0,0/*0x253048*/),
            new java.awt.Color(30,30,30/*0x182635*/)
        };
        ...
        {
            new java.awt.Color(20,40,50),
            new java.awt.Color(10,28,30)
        };
        final java.awt.Color[] COLORS_RIGHT =
        {
            new java.awt.Color(30,48,59),
            new java.awt.Color(11,23,32)
        };
        ...
        try
        {
          g2.drawImage(javax.imageio.ImageIO.read(Sonogram.class.getResource("Schraube1.png")),2,163, null);
        }
        catch(Throwable t)
        {
        }
    ...
    private java.awt.image.BufferedImage createDigit(int digit)
    {
        ...
        if (digit < 0)
          IMAGE = gfxConf.createCompatibleImage(43, 6, java.awt.Transparency.TRANSLUCENT);
        else      
          IMAGE = gfxConf.createCompatibleImage(46, 65, java.awt.Transparency.TRANSLUCENT);
    ...
    public void mouseClicked(java.awt.event.MouseEvent event)
    {
      ...
      {
        colorSwitch ++;
        if (colorSwitch >= 3 || colorSwitch < 0)
          colorSwitch = 0;
        initDigitArray();
      }
    }
