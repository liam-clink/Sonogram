...
public class Surface extends JFrame 
{
  ...
  public Surface(Sonogram sono, boolean isWvArgument) 
  {
    ...
    setLocation(150,150);
    if (isWv == true)
      setTitle("Wigner-Ville - Perspectogram");
    else
      setTitle("Perspectogram");
    ...
    canvas3D.addMouseListener (new MouseInputAdapter() 
      {
        public void mouseClicked(MouseEvent e) {rotateThread.resetTime();}
        public void mouseDragged(MouseEvent e) {rotateThread.resetTime();}
        public void mouseEntered(MouseEvent e) {rotateThread.resetTime();}
        public void mouseMoved(MouseEvent e)   {rotateThread.resetTime();}
        public void mousePressed(MouseEvent e) {rotateThread.resetTime();}
        public void mouseReleased(MouseEvent e){rotateThread.resetTime();}
      }
    );
    ...
    canvas3D.addKeyListener (new KeyAdapter() 
      {
        public void keyPressed(KeyEvent e)     {rotateThread.resetTime();}
        public void keyReleased(KeyEvent e)    {rotateThread.resetTime();}
        public void keyTyped(KeyEvent e)       {rotateThread.resetTime();}		
      }
    );
  ...
  class message extends Thread implements ActionListener
  {
    ...
    public void run()
    {
      askAgain = new JCheckBox("<html><i><font size = -2>Do not show this information message again");
      Object[] message = new Object[2];
      message[1] = askAgain;
      message[0] = "<html><font size = 4>You can use the mouse or the keyboard<br>"+
      ...
      JDialog dialog = pane.createDialog(Surface.this, "Usage Information - Mouse and Keyboard Shortcuts");
    ...
    public void actionPerformed(ActionEvent e)
    {
      if (askAgain.isSelected() == true)
        Surface.reftomain.perkeysconfirm = true;
    }
  }
  ...
  public BranchGroup createSceneGraph() 
  {
      ...
      if (reftomain.gad.cuniverse.isSelected()==true) 
      {
        ...
        Sphere sphereObj = new Sphere(3.0f, Sphere.GENERATE_NORMALS |
                                            Sphere.GENERATE_NORMALS_INWARD|
                                            Sphere.GENERATE_TEXTURE_COORDS,40);
        Appearance backApp = sphereObj.getAppearance();
        TextureLoader tex = new TextureLoader(Sonogram.class.getResource("bg.jpg"),new String("RGB"),this);
        if (tex != null)
      ...
      myMouseTranslate.setSchedulingBounds(new BoundingSphere(new BoundingSphere(new Point3d(0,0,0),400.0)));
      objRoot.addChild(myMouseTranslate);
      MouseZoom myMouseZoom = new MouseZoom();
      myMouseZoom.setTransformGroup(objTransform);
      myMouseZoom.setSchedulingBounds(new BoundingSphere(new BoundingSphere(new Point3d(0,0,0),400.0)));
  ...
  {
  	private int time=0;
  	public SceneRotatorThread() {start();}
