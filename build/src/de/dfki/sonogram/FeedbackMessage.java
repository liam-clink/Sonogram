...
public class FeedbackMessage extends JDialog 
{
  ...
  public FeedbackMessage(Sonogram ref) 
  {
  	...
  	email.setToolTipText("<html>You do not need to advise you eMail adress<br>to send this message, but if you do so i can<br>give you a feedback message.");
  ...
  public void sendText(String text) 
  {
  	...
  	if (mailSender.sentEmailMessage(text) == true) {
  	    JOptionPane.showMessageDialog(reftomain,"<html>Your message <u>has been sent</u>. We will contact you shortly if your<br>message requires a response, and you provided an email address.","Message successfully Sent...",1,new ImageIcon(Sonogram.class.getResource("chris.jpg")));
