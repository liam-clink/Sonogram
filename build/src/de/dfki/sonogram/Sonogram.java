 ...
 * clauer@dfki.de - www.dfki.de <p>
 * Main class of <b>Sonogramm visible speech</b>
 * Sonogram is an generic and a in many forms configurable acoustical signal processing tool.
 * It uses Java Media Framework and Java3D an external libraries, both are available fron Sun Microsystems.
 * This CLASS implements also the MAIN CLASS.
...
public class Sonogram extends JFrame implements ActionListener, MouseListener 
{
    ...
    JMenuItem                quitItem,openItem,aboutItem,adjItem,playItem,revItem,d3Item // Menueitems - MainWindow
                             ...
                             ,csvItem,svgItem,sysItem,memItem,impItem,defaultItem,webItem
                             ,wavItem,fulItem,walItem,arrItem,closeItem,autocorrelationItem
	                           ,pitchItem,feedbackItem,licenseItem,welcomeItem,recordItem,splashItem;
    JMenuItem[]              hotlist;
    JMenu                    menuFile;
    JRadioButtonMenuItem     hamItem, rectItem, blaItem, hanItem, triItem, welItem, gauItem, flaItem, harItem, cosItem, asyItem; // Menueitems - submenue WinFunkt
    JRadioButtonMenuItem     colItem, bwItem, firecItem, fireItem, rainItem, greenItem;                   // Menueitems - Radiobattons MW
    ...
    int            isacpws;
    int            isacpmax;
    final static int    isetu = 10;                                      // the dmeo minutes
    final static String Plugo = "PluginParameterFromExternalCalto";     // others in SonoSplashScreen and WelcomeScreen
            ...
            public void run() 
            {
              ...
              java.awt.Toolkit.getDefaultToolkit().beep();
							...
							int n = JOptionPane.showOptionDialog(
							    Sonogram.this,
							    "<html><i>The trial time has expired. Sonogram will quit now.<br>You can obtain the full version from the Sonogram homepage.",
							    "Trial Time expired...",
              ...
              //JOptionPane.showOptionDialog(Sonogram.this,"<html><i>The trial time has expired. Sonogram will quit now.<br>You can obtain the full version from the Sonogram homepage."/*:<br><font size=4><a href=http://www.christoph-lauer.de>www.christoph-lauer.de</a>"*/,"Trial Time expired...",JOptionPane.INFORMATION_MESSAGE);
		          System.out.println("--> Bye");
		          saveConfig();
							if (n == 1)
		            try
                {
                  Desktop.getDesktop().browse( new java.net.URI("http://www.christoph-lauer.de/store") );
                }
        ...
        if (capsLock == true)
        {
          Object[] options = {"Delete and Launch","Delete and Quit","Cancel"};
	        int confirm = JOptionPane.showOptionDialog(
	                                                     this,
	                                                     "<html>Your <u>CapsLock</u> is activated. This special key is used in Sonogram while<br>"+
	                                                     "startup to <u>delete the configuration file</u> from the disk to reset Sonogram.<br>"+
	                                                     "Note that all stored settings are lost if you delete the configuration file.<br>"+
	                                                     "<br><font size=4>Do you want to delete the Configuration File ?",
          ...
          if (confirm == JOptionPane.OK_OPTION || confirm == 1)
          {
            ...
            if(success == false)
              JOptionPane.showMessageDialog(this,"<html><font color=#DD0000>Error</font> while delte the <u>SonogramConfig.xml</u> File !", "Can't Delete Config File", JOptionPane.ERROR_MESSAGE);
            if (confirm == 1)
              System.exit(0);
		      }
		    }
            ...
            if (filepath != null && iopenlast == true) {
                if (filepath.substring(0,2).equals("ft")==true || filepath.substring(0,2).equals("ht")==true) {
                    ...
                    int confirm = JOptionPane.showOptionDialog(this,
                                  "<html><i>The last opened file in Sonogram was a remote network file:</i><br>URL: <u>" + filepath +
                                  "</u><br><br><i><font size = 4>Continue <u><font color=#660000>open this remote File</font></u> over the Network ?", "Open last Remote Network File ?"
                                  ,JOptionPane.YES_NO_OPTION
                    ...
                    if (file.exists()==true) {          // Check for file if existsy
                        ...
                        messageBox("Error while automatical opening a File","<html>You have selected the automatical open feature<br>while statup in the Sonogram-Settings-Dialog<br>but the <u><font color=#660000>stored history file does not exist</u></font> !<br><br>File: <i><u>"+filepath,1);
...
*/    }
    ...
    public static void main(String[] args) 
    {
        ...
        {
            JOptionPane.showMessageDialog(null,"<html><i>Java Media Framework is <u>not installed</u>.<br>Please look at www.java.sun.com.","JMF ERROR",JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"<html><i>Could not create Sonogram maincllass.\nPlease include Sonogram.jar in Classpath.","Sonogram Class not found !",JOptionPane.ERROR_MESSAGE);
            if (plugin == true) {
                try     // Call Plugin exit class
                {
                    // Check Class for exist
        ...
        catch (Throwable th)
        {
            ...
            JOptionPane.showMessageDialog(null,"<html><i>The <u>Java3D extension is not installed</u> ! In order to generate<br>the 3D Perspectograms you must have Java3D installed. Java3D<br>can be obtained from www.java.com. Sonogram will start up<br>altought normal without Java3D, but the <u>3D Perspectogram<br>functionality is disabled<u>.","Please install Java3D",JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,"<html><font size = 4 color = #660000>An Unhandled Error occoured!!!<br><font size = 5 color = #FF0000>" + e,"Unhandled Error Occoured",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void setLookAndFeel(int which) 
    {
	    try 
	    {
	     ...
	     else if (which >= 1 && which <=5) 
	     {
		      ...
		      if ( which == 2)
		        kunststoffLF.setCurrentTheme(new com.incors.plaf.kunststoff.themes.KunststoffDesktopTheme());
		      if ( which == 3)
        		kunststoffLF.setCurrentTheme(new com.incors.plaf.kunststoff.themes.KunststoffNotebookTheme());
		      if ( which == 4)
		        kunststoffLF.setCurrentTheme(new com.incors.plaf.kunststoff.themes.KunststoffPresentationTheme());
		      if ( which == 5)
  	    ...
  	    if (wvconfig.frame != null)
  	       SwingUtilities.updateComponentTreeUI(wvconfig.frame);
      ...
      {
        messageBox("Error in Look-And-Feel switch","<html>Error while <u><font color=#660000>change the Look-And-Feel</u></font> Theme. Perhaps the<br>selected Look-And-Feel is not supported on your OS.",2);
      }
    }
    ...
    class CalcThread extends Thread 
    {
    	...
    	CalcThread(int a_index, double a_i, int a_transformationlength, int a_offset, float a_windowbuffer[]) 
  	  {
        this.i = a_i; 
	...
	float[] spekbuffer = null;
        ...
        for(int v=0;v<transformationlength;v++) 
        {                         // Copy from DataSourceReader
        ...
        {                       // if Smooth Spektrum ower frequency is set
    ...
    public void readerIsBack() {
        try {
            ...
            if (ffttrans==false) {                                                 // LPC
                progmon.setNote("Calculate the Spectrum with the Linear-Predictive-Coding-Transformation for the File:  «" + filename + "» (using " + NTHREADS + " cores)");
                ...
                progmon.setNote("Calculate the Spectrum with the Fast-Fourier-Transformation for the File:  «" + filename + "» (using " + NTHREADS + " cores)");
            ...
            int index = 0;
			      // precalc the size
            for (double i=0;i<(samplestotal-transformationlength);i+=((double)timewindowlength/overlapping)) {index++;}
            ...
            if (alwaysinlist == false) {                                  // Add Menue entry
                ...
                String tmp = (String)filehistory.get(newlen-1);          // Get New String from new Path
		            ...
		            if (tmpName.length() > 32)
									tmpName = tmpName.substring(tmp.length()-32);
								// add the new file to the history
                if (tmp.substring(0,4).equals("http")==true)
                  hotlist[newlen-1] = new JMenuItem("<html>" + (newlen-1) + "&ensp;<font color=A0A0B4>HTTP:</font>&ensp;<font size=-2>" + tmpName, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
                if (tmp.substring(0,3).equals( "ftp")==true)
                  hotlist[newlen-1] = new JMenuItem("<html>" + (newlen-1) + "&ensp;<font color=A0A0B4>FTP:</font>&ensp;&ensp;&thinsp;&thinsp;<font size=-2>" + tmpName, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
                if (url.substring(0,4).equals("file")==true)
                  hotlist[newlen-1] = new JMenuItem("<html>" + (newlen-1) + "&ensp;<font color=6A0A0B4>FILE:</font>&emsp;<font size=-2>" + tmpName, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
		...
		hotlist[newlen-1].setToolTipText("<html>Path to file"+num+":<br><b>"+(String)filehistory.get(newlen-1)+"</b>");
                ...
                if (newlen-1==0)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_0,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==1)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_1,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==2)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_2,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==3)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_3,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==4)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_4,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==5)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_5,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==6)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_6,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==7)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_7,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==8)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_8,java.awt.event.InputEvent.CTRL_DOWN_MASK);
                if (newlen-1==9)
                    key = KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_9,java.awt.event.InputEvent.CTRL_DOWN_MASK);
        ...
        catch (Exception e) 
        {
            ...
            e.printStackTrace();
            messageBox("Error while the Sonogram generation","<html>An <u><font color=#660000>error occoured while the generation</u></font> of the Sonogram.<br>Please see the console output for more Details.",JOptionPane.ERROR_MESSAGE);        
        }
        finally
        {
            progmon.close();
  ...
  sep4 = new JLabel(new ImageIcon(Sonogram.class.getResource("separator.png")));
        ...
        playbutton.setToolTipText("<html><b>Play</b> the selected timespan      <font color=black size=-2>SPACE");
        ...
        forbutton.setToolTipText("<html> <h2>F(f)=\u2131{f(t)}</h2>Shows the <b>FFT</b> Window      <font color=black size=-2>Ctrl-F");
        ...
        wavbutton.setToolTipText("<html>Shows the <b>Waveform</b> dialog.<br>Displays the Amplitude Waveform in the time domain  <font color=black size=-2>CTRL-W");
	...
	zprebutton.setMaximumSize(buttonSize);
        ...
        toolBar.add(sep2);
			  ...
			  logbutton.setToolTipText("<html><b>Linear/Logrithmic</b><br>Switch between the <b>linear</b> and<br> the <b>logarithmical</b> frequency scale  <font color=black size=-2>Ctrl-L");
        ...
        infobutton.setToolTipText("<html>Parameter, values and statistics<br> abuot the Signal and the Sonogram      <font color=black size=-2>Ctrl-Y");
        toolBar.add(infobutton);        d3button = new JButton(new ImageIcon(Sonogram.class.getResource("3d.gif")));
        d3button.setPreferredSize(buttonSize);
	      d3button.setMaximumSize(buttonSize);
        toolBar.add(d3button);
        d3button.setToolTipText("<html>Open the <b>3D Perspectogram</b> for<br>the Sonogram displayed in the<br>main window <font color=black size=-2>Ctrl-S");
        ...
        wvbutton.setToolTipText("<html><font size=5>Ultrazoom</font><br><font color = black>The Pseudo-Smoothed-Wigner-Ville Transformation<br>is only available for very small signals. To use this killer feature<br>you must zoom in, or select a small area with the mouse. You can see<br>the numbers of Samples in the Information Window.<br><br><font color = black><b>Hold [CTRL] or use Right-Mouse-Button for direct Rendering.");
        ...
        helpbutton.setToolTipText("<html>Open the Sonogram <b>Online Help</b>      <font color=black size=-2>Ctrl-H");
        ...
        quitbutton.setToolTipText("<html><b>Exit</b> Sonogram without saving anything      <font color=black size=-2>Ctrl-Q");
           ...
           if (gridItem.isSelected() == true)
			...
			if (e.getSource()==logbutton) 
			{
	         ...
	         logfrItem.setSelected(!logfrItem.isSelected());
					 ...
					 if (logfrItem.isSelected() == true)
					    ...
					    logbutton.setBorder(BorderFactory.createEmptyBorder());//fullbutton.getBorder());
	    }
			...
			if (e.getSource()==smoothfrbutton) 
			{
			    ...
			    smoothfrbutton.setBorder(BorderFactory.createLoweredBevelBorder());
				  ...
				  smoothfrbutton.setBorder(BorderFactory.createEmptyBorder());//fullbutton.getBorder());
			}
			...
			if (e.getSource()==smoothtmbutton) 
			{
			  gad.p1.setSelectedIndex(3);
			    ...
			    smoothtmbutton.setBorder(BorderFactory.createLoweredBevelBorder());
				  ...
				  smoothtmbutton.setBorder(BorderFactory.createEmptyBorder());//fullbutton.getBorder());
			}
				
		  if (e.getSource()==wvbutton) 
			{
			 if( 
			     (wvbutton.isEnabled()==true && (e.getModifiersEx() & java.awt.event.InputEvent.CTRL_DOWN_MASK) == java.awt.event.InputEvent.CTRL_DOWN_MASK) ||
...
//-------------------------------------------------------------------------------------------------------------------------
    ...
    private void createMenu () 
    {
        ...
        quitItem = new JMenuItem ("Exit Sonogram",new ImageIcon(Sonogram.class.getResource("quit.gif")));
        impItem  = new JMenuItem ("Open Sonogram from SVG",new ImageIcon(Sonogram.class.getResource("imp.gif")));
        recordItem = new JMenuItem ("Audio Recorder",new ImageIcon(Sonogram.class.getResource("rec.png")));
        svgItem  = new JMenuItem ("Export Sonogram as SVG Image File",new ImageIcon(Sonogram.class.getResource("svg.gif")));
        saveItem = new JMenuItem ("Export Sonogram as PNG Image File",new ImageIcon(Sonogram.class.getResource("save.gif")));
        csvItem  = new JMenuItem ("Export Sonogram as CSV Text File",new ImageIcon(Sonogram.class.getResource("csv.gif")));
        printItem= new JMenuItem ("Print Sonogram",new ImageIcon(Sonogram.class.getResource("print.gif")));
        openItem = new JMenuItem ("<html>Open <u>local</u> Media File",    new ImageIcon(Sonogram.class.getResource("open.gif")));
        webItem  = new JMenuItem ("<html>Open <u>remote</u> Media File",new ImageIcon(Sonogram.class.getResource("web.png")));
        ...
        for (int i=0;i<filehistory.size();i++)
        {
            ...
            if (filecheck[i]==0)
              hotlist[i] = new JMenuItem("<html>" + i + "&ensp;<font color=A0A0B4>FILE:</font>&emsp;<font size=-2><strike>" + tmp, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
            if (filecheck[i]==1)
              hotlist[i] = new JMenuItem("<html>" + i + "&ensp;<font color=A0A0B4>FILE:</font>&emsp;<font size=-2>" + tmp, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
            if (filecheck[i]==2)
              hotlist[i] = new JMenuItem("<html>" + i + "&ensp;<font color=A0A0B4>HTTP:</font>&ensp;<font size=-2>" + tmp, new ImageIcon(Sonogram.class.getResource("fileMenue.gif")));
            if (filecheck[i]==3)
              hotlist[i] = new JMenuItem("<html>" + i + "&ensp;<font color=A0A0B4>FTP:</font>&ensp;&ensp;&thinsp;&thinsp;<font size=-2>" + tmp, new ImageIcon(Sonogram.class.getResource("hin.gif")));
        ...
        delhistItem = new JMenuItem("<html><font size=-2>&emsp;&emsp;&emsp;&emsp;&emsp;<u>« Delete the File History »</u>",new ImageIcon(Sonogram.class.getResource("rem.gif")));
        menuFile.add(delhistItem);
        menuFile.addSeparator();
        menuFile.add (quitItem);

        JMenu menuOther = new JMenu ("Options");
        adjItem         = new JMenuItem("Sonogram-Settings-Dialog", new ImageIcon(Sonogram.class.getResource("adj.gif")));
        defaultItem     = new JMenuItem("Default Settings"  , new ImageIcon(Sonogram.class.getResource("def.gif")));
        arrItem         = new JMenuItem("Arrange Windows",    new ImageIcon(Sonogram.class.getResource("arr.gif")));
        lafItem         = new JMenuItem("Select LookAndFeel", new ImageIcon(Sonogram.class.getResource("laf.gif")));
        JMenu windFunkt = new JMenu("Window Function");
        hamItem  = new JRadioButtonMenuItem("Hamming Window", new ImageIcon(Sonogram.class.getResource("ham.gif")));
        rectItem = new JRadioButtonMenuItem("Rectangle Window", new ImageIcon(Sonogram.class.getResource("rect.gif")));
        blaItem  = new JRadioButtonMenuItem("Blackman Window", new ImageIcon(Sonogram.class.getResource("bla.gif")));
        hanItem  = new JRadioButtonMenuItem("Hanning Window", new ImageIcon(Sonogram.class.getResource("hen.gif")));
        welItem  = new JRadioButtonMenuItem("Welch Window", new ImageIcon(Sonogram.class.getResource("wel.gif")));
        triItem  = new JRadioButtonMenuItem("Triangle  Window", new ImageIcon(Sonogram.class.getResource("tri.gif")));
        gauItem  = new JRadioButtonMenuItem("Gaussian Window", new ImageIcon(Sonogram.class.getResource("gau.gif")),true);
        flaItem  = new JRadioButtonMenuItem("Flat-Top Window", new ImageIcon(Sonogram.class.getResource("fla.gif")),true);
        harItem  = new JRadioButtonMenuItem("Harris Window", new ImageIcon(Sonogram.class.getResource("ham.gif")),true);
        cosItem  = new JRadioButtonMenuItem("Cosine Window", new ImageIcon(Sonogram.class.getResource("wel.gif")),true);
        asyItem  = new JRadioButtonMenuItem("Asymetrical Window", new ImageIcon(Sonogram.class.getResource("asy.gif")),true);
        ...
        firecItem       = new JRadioButtonMenuItem("Classical Fire Colors", new ImageIcon(Sonogram.class.getResource("firec.png")),true);
        fireItem        = new JRadioButtonMenuItem("Modern Fire Colors",   new ImageIcon(Sonogram.class.getResource("fire.gif")),true);
        ...
        greenItem       = new JRadioButtonMenuItem("Purple Colors",new ImageIcon(Sonogram.class.getResource("gre.gif")) );
        bwItem          = new JRadioButtonMenuItem("Classical Black/White",   new ImageIcon(Sonogram.class.getResource("bw.gif"))  );
        bg.add(firecItem);
        bg.add(fireItem);
        bg.add(colItem);
        bg.add(rainItem);
        bg.add(greenItem);
        bg.add(bwItem);
        negItem         = new JCheckBoxMenuItem   ("Inverse Color",        new ImageIcon(Sonogram.class.getResource("neg.gif")));
        gridItem        = new JCheckBoxMenuItem   ("Show Grid",            new ImageIcon(Sonogram.class.getResource("grid.gif")));
        logItem         = new JCheckBoxMenuItem   ("Logarithmical Amplitude",  new ImageIcon(Sonogram.class.getResource("log.gif")),true);
        logfrItem       = new JCheckBoxMenuItem   ("Logarithmical Frequency",  new ImageIcon(Sonogram.class.getResource("logfr.gif")));
        fulItem         = new JCheckBoxMenuItem   ("<html>Fullscreen<font size=-3>&emsp;&emsp;(doubleklick)",  new ImageIcon(Sonogram.class.getResource("ful.gif")));
        ...
        zinItem  = new JMenuItem ("Zoom Marked",new ImageIcon(Sonogram.class.getResource("small_zin.gif")));
        zbaItem  = new JMenuItem ("Zoom Full",new ImageIcon(Sonogram.class.getResource("small_zba.gif")));
        zpreItem = new JMenuItem ("Zoom Previous",new ImageIcon(Sonogram.class.getResource("small_zpre.gif")));
        ...
        aboutItem      = new JMenuItem ("About Sonogram", new ImageIcon(Sonogram.class.getResource("about.gif")));
        ...
        welcomeItem    = new JMenuItem ("Welcome Screen", new ImageIcon(Sonogram.class.getResource("welcome.gif")));
        splashItem     = new JMenuItem ("Splash Screen", new ImageIcon(Sonogram.class.getResource("splash.gif")));
        sysItem        = new JMenuItem ("Java System Info", new ImageIcon(Sonogram.class.getResource("ja.png")));
        ...
        infoItem.setToolTipText("<html>The Information Dialog holds <b>Values</b> and<br><b>Statistics</b> about the Signal and the Sonogram");
        ...
        svgItem.setToolTipText("<html><b>Save</b> Sonogram as <b>SVG</b><br>(Scalable Vector Graphic)<br>Sonogram's native file format");
        csvItem.setToolTipText("<html><b>Save</b> Sonogram as <b>CSV</b> text file.<br>(Comma Separated Values)");
        sysItem.setToolTipText("<html>System and Java VM <b>Information");
        memItem.setToolTipText("<html><b>Memory</b> usage of the Java VM");
        defaultItem.setToolTipText("<html>Set all the <b>Sonogram-Settings-Dialog</b><br> parameters back to the default <b>Initial</b> settings");
        ...
        webItem.setToolTipText("<html>Open a <b>Remote</b> media file<br>over the Network with an <b>URL</b>");
        wavItem.setToolTipText("<html>Show the <b>Waveform</b> Window.<br>Displays the Amplitude in the time aligned domain");
        ...
        licenseItem.setToolTipText("<html>Sonogram is licensed under the<br><b>Christoph Lauer Engineering Commercial License</b><br>in version 1.0");
        ...
        quitItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Q,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        openItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        adjItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        lafItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        negItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        gridItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        logItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_K,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        infoItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        d3Item.setAccelerator  (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_3,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        playItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        revItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        stopItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        cepItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        lpcItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        forItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        zinItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        zbaItem.setAccelerator (KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_B,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        zpreItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        helpItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F1,0));
        saveItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        printItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        svgItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        csvItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        logfrItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        impItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y,java.awt.event.InputEvent.CTRL_DOWN_MASK));
        webItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_U,java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    public void actionPerformed (ActionEvent e) {
        ...
        {
	        int confirm = JOptionPane.showOptionDialog(this,"<html>You want to <i><u>close Sonogram</u></i> ?","Exit Sonogram ?",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,null,null);
          if (confirm == 0)
          {
		        System.out.println("--> Bye");
		        saveConfig();
       ...
       {                                       // AboutItem
        ...
        {
          license = "<font color = #646496 size = 4>Licensed to:<font color = #242446 size = 5>"+
          // including some licensing information
          "<br>"   + Licenses.zoda1.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda2.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda3.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda4.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda5.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda6.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda7.replaceAll("\\s+$", "") +
          "<br>"   + Licenses.zoda8.replaceAll("\\s+$", "") + "</font>";
        }
            String yearStr = Integer.toString(Calendar.getInstance().get(Calendar.YEAR));
        
            messageBox("SONOGRAM VISIBLE SPEECH version " + version + " BUILD " + build,
                       "<html>"+
                       "The SPWVD based SuperZOOM function extracts the so far best known<br>"+
                       "resolution in the time and frequency domain. Sonogram can also display<br>"+
                       "display so called three dimensional Perspectograms if Java3D is installed.<br><br>"+
                       "<font color = #646496 size = 2>Licensed to (LICENSE STRING):" +
                       "</font><br>"  + 
                       "<hr><table border=0><tr><td><font size =5 color = #222266>LICENSE:</td><td><font size = 5>FREE FULLVERSION</td></tr><br>"+
                       "<td><font size =5 color = #222266>VERSION:</td><td><font size = 5>"+version+"</td>"+
                       "<tr><td><font size = 5 color = #222266>BUILD: </td><td><font size = 5>"+build+"</td></tr></font></table>"+
                       "<hr><br><i><font size=3><center>programed from 2000 to " + yearStr+ " by © Christoph Lauer Engineering"+
        ...
        for (int i=0;i<filehistory.size();i++) {                             // Filehistory
            if (e.getSource() == hotlist[i]) 
						{
							if (((String)filehistory.get(i)).substring(0,4).equals("http")==true || ((String)filehistory.get(i)).substring(0,3).equals("ftp")==true)
							  fileisfromurl = true;
							else
							  fileisfromurl = false;
        ...
        if (e.getSource()==delhistItem)
				{                                    // Delte Hotlist
					if (filehistory.size() != 0)
				  {
            int confirm = JOptionPane.showOptionDialog(this,
                        "<html><i>Are you sure you want to <u>remove all<br> elements</u> from the file history  ?", "Delete the File History"
                        ,JOptionPane.YES_NO_OPTION
                        ,JOptionPane.QUESTION_MESSAGE
                        ,null,null,null);
             if (confirm == 0) 
        ...
        if (e.getSource()==saveItem) 
        {
            ...
            {
              JOptionPane.showMessageDialog(this,"<html><i>An eror occoured while save the image.<br>" +
        ...
        if (e.getSource()==sysItem) 
        {
            ...
            sysopt += "</i><br>MP3 Available: <i>YES";
	          ...
	          if (splash.javaSplash == true)
	            sysopt += "NATIVE JAVA STARTUP SPLASH-SCREEN";
	          else
	            sysopt += "OWN SPLASH-SCREEN";
	          sysopt += "</i><br>Splash Transparency: <i>";
	          
	          if (splash.nativeTransparency == 1)
	            sysopt += "NATIVE JAVA STARTUP SPLASH WITH TRANSPARENCY";
	          if (splash.nativeTransparency == 2)
	            sysopt += "FAKED BACKGROUND-IMAGE TRANSPARENCY";
	          if (splash.nativeTransparency == 3)
	            sysopt += "JAVA-IMAGE TRANSPARENCY";
	            
	         int memMb = (int)Math.round(Runtime.getRuntime().totalMemory()/1024/1024);
           String memMessage;
           if (memMb < 1000) 
             sysopt += "</i><br>Currently allocated memory: <i><font color=#AA0000 size=3>" + memMb + " MB";
           else 
             sysopt += "</i><br>Currently allocated memory: <i><font color=#AA0000 size=3>" + Math.round((double)memMb)/1000.0 + " GB";

	         memMb = (int)Math.round(Runtime.getRuntime().freeMemory()/1024/1024);
           if (memMb < 1000) 
             sysopt += "</i><br>Currently available free memory: <i><font color=#AA0000 size=3>" + memMb + " MB";
           else 
             sysopt += "</i><br>Currently available free memory: <i><font color=#AA0000 size=3>" + Math.round((double)memMb)/1000.0 + " GB";

           int NTHREADS = Runtime.getRuntime().availableProcessors();
           sysopt += "<font size=-2 color=#000044></i><br>Numer of available Processor Cores: <font color=#AA0000 size=3><i>" + NTHREADS + " Cores</font>";
	         sysopt += "</i><font size=-2 color=#110033><br>Startup Time: <i>" + Double.toString(startupSeconds) + " Seconds";

           JOptionPane.showMessageDialog(this, sysopt, "Java System Properies", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(Sonogram.class.getResource("java.png")));
        }
        ...
        if (e.getSource()==defaultItem) {
            ...
            int confirm = JOptionPane.showOptionDialog(this,
                          "<html><i>Are you sure you want to Reset all Parameters<br>and Settings <u>back to the initial Values</u> ?", "Reset all Settings"
                          ,JOptionPane.YES_NO_OPTION
                          ,JOptionPane.QUESTION_MESSAGE
                          ,null,null,null);
            if (confirm == 0) 
		...
		initGadToDefault();
            ...
            int confirmplacemet = JOptionPane.showOptionDialog(this,
                                  "<html><i>Reset all Windows to there <u>default position and location</u> ?", "Reset Window Placement"
                                  ,JOptionPane.YES_NO_OPTION
                                  ,JOptionPane.QUESTION_MESSAGE
                                  ,null,null,null);
    ...
    public void arrangeWindows() 
    {
      ...
      if(fv.isVisible() && wv.isVisible() && lv.isVisible() && cv.isVisible() && kv.isVisible() && av.isVisible() && pv.isVisible())       
      {
        fv.setVisible(false);
        wv.setVisible(false);
        cv.setVisible(false);
    ...
    */
    ...
    {
        if (wvconfig.isVisible() == true)
          wvconfig.setVisible(false);
        if (fp == null) {
        ...
        {        
          ...
          if (mp3confirm == false)
          {
            JCheckBox askAgain = new JCheckBox("<html><i><font size = -2>Do not show this information message again");
            Object[] message = new Object[2];
            message[0] = "<html>The MP3 file must be <u><font COLOR=#660000>converted to a WAVE file</u></font>. This may<br>"+
                         "take a little. The converted WAVE file will be placed in the<br>"+
                         "same folder as the MP3 file and can have a big File size.<br>"+
                         "Please note that very large MP3's produce big Spectograms,<br>"+
                         "and you must first zoom-in to see any usefully information.<br>"+
                         "It could also be that the Sonogram was fogged because the<br>"+
                         "grid is to dense. Disable the grid in this case.<br>"+
                         "<br><font size=4>Continue with the convertion ?";
            message[1] = askAgain;
          ...
          {
            JOptionPane.showMessageDialog(null,"<html>An Error occoured while the MP3 Convertion.<br>The selected MP3 File can not be opened !","MP3 Convertion ERROR",JOptionPane.ERROR_MESSAGE);
          }
          fp = wavFileName;      
        }
        // MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 MP3 M 
    ...
    private void normalizeSpekt() 
    {
        ...
        {                                  // find min/max Points of Spektrum
	...
	itooltip   = true;
        ...
        islwavetime= 4;
        isldb      = 0;
        ilaf       = 1; // NOTE --> the value is seem from the button. This is not the hash key of the hash table in the dialog but the SLIDER value, more like MAX-KEY...  
        isacwl     = 3;
        isacws     = 3;
        isr        = 2;
