...
/**
 * Copyright (c) 2010 Christoph Lauer @ DFKI, All Rights Reserved.
 * clauer@dfki.de - www.dfki.de
 * <p>
 * Displays the welcome screen in the screen center.
  ...
  public WelcomeScreen(boolean show) {
	// set the LAF for the button 
        ...
        splash.setSize(pic.getIconWidth(),pic.getIconHeight());
				...
				// add the button
				button = new JButton("« Continue »"); // do not save as UTF8 Format because the special charcter ! Konown to be work well --> Iso8859-1(windows) and CRLF(windows)
