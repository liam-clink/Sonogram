 ...
 * <p>
 * This class reads <i>Sonogramm</i> settings from XML file
 * named SonogramConfig.xml
        ...
        try {
            ...
            if (sono.iopenlast==true)         // For Datasourcereader to leave width and start
                sono.autoopened = true;
						...
						while (sono.filehistory.size() > 10)
							sono.filehistory.removeElementAt(0);
            ...
            System.out.println("--> No Configfile Found. Will create one.");
	    			//sono.messageBox("Create a new SonogramConfig.xml Configuration File","The Sonogram configuration file SonogramConfig.xml is not available\nwhy Sonogram will now create this File. This is normal if Sonogram starts\nfirst time. All the program options, settings and values are stored there.\nIf Sonogram has any problems while startup simple remove the old\nSonogram.xml file and Sonogram will create a new one with the default\ninitial values.",1);
	    successfully = false;
