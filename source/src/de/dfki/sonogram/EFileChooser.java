    ...
    public void setFile(File f)
    {
      if (f.exists() == true)
      {
        ...
        if (parentFolder != null)
          findPanel.chooser.setCurrentDirectory(parentFolder);
...
class FindAccessory extends JPanel
    ...
    */
    ...
    public FindAccessory (String titleForBorder) {
        ...
        add
            (pathPanel = new FindFolder(),BorderLayout.NORTH);
        add
            (searchTabs = new FindTabs(),BorderLayout.CENTER);
        add
            (controlPanel = new FindControls(actionStart,actionStop,true),
                    BorderLayout.SOUTH);
