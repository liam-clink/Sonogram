...
class SpectrumPanel extends JPanel implements java.awt.event.ActionListener
{
  ...
  public java.awt.image.BufferedImage createBackground(int width, int height)
  {
    ...
    {
        new java.awt.Color(10,25,12),
        new java.awt.Color(10,15,10)
    };
    ...
    try
    {
      g2.drawImage(javax.imageio.ImageIO.read(Sonogram.class.getResource("Schraube1.png")),538,163, null);
    }
    catch(Throwable t)
    {
    }
    ...
    // the grid
    java.awt.BasicStroke STROKE = new java.awt.BasicStroke(1.0f, java.awt.BasicStroke.CAP_SQUARE, java.awt.BasicStroke.JOIN_BEVEL);
    g2.setStroke(STROKE);
    ...
    STROKE = new java.awt.BasicStroke(4.0f, java.awt.BasicStroke.CAP_SQUARE, java.awt.BasicStroke.JOIN_BEVEL);
    g2.setStroke(STROKE);
