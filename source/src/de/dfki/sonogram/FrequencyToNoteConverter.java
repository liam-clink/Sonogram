...
/**
 * Copyright (c) 2011 Christoph Lauer @ CLEngineering, All Rights Reserved.
 * christophlauer@me.com - www.christoph-lauer.de
 * <p>
 * This class presents a frequency to note converter and contains
 * a simple static function for the conversion.
...
public class FrequencyToNoteConverter
{
  ...
  public static String query(double paramDouble)
  {
    ...
    if (paramDouble >= d1) {
      ...
      if (d3 * d1 - paramDouble < paramDouble - d1)
        j++;
      if (j > 50) {
        i++;
        j = 100 - j;
      ...
      if (paramDouble - d1 / d3 < d1 - paramDouble)
        j++;
      if (j >= 50) {
        i--;
        j = 100 - j;
