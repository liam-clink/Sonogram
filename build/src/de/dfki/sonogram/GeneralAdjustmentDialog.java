 ...
 * <p>
 * The Oprions Dialog for Sonogram
...
class GeneralAdjustmentDialog extends JFrame {
    ...
    JCheckBox      cinv,clog,cgrid,cauto,cback,csmooth,cacpoints
    ,csmoothsi,cenergy,cllog,clfor,csampl,csmoothx
    ,cspitch,cspitchlimitation,coverlapping,csavehist
    ,cspitchonely,cspitchblack,cspitchsmooth,csspecwhileplaying
    ,csloop,cscolsi,cslogfr,cgrid2,csavescreepos,cssaveconf,csopenlast
    ,copenlastwithzoom,ccep,cceplog,cwavelines,cmute,clocalpeak
    ,cuniverse,clogwal,csarrange,cacsmooth,cacpitch,cantialise,cwfnorm
	  ,ccepsmooth,cppoints,cplimitfr,cpsmooth,cscrennsaver,cperantialias,cpercoord,cpraway,cptrack,cpfog,ctooltip;
    JTabbedPane    p1;
    JButton        cb;
    JComboBox      wcb;
    ...
    //-------------------------------------------------------------------------------------------------------------------------
    /**
     * Construktor for Dialogfield 
     * Defines Buttonfunktions and 
     * set Outfit.
     */
    public GeneralAdjustmentDialog (Frame owner) {
        ...
        ActionListener rlst = new ActionListener() {
        ...
        ActionListener dlst = new ActionListener() {
                                  public void actionPerformed(ActionEvent e) {
                                      if (sono.spektrumExist==true) {
        ...
        ActionListener clst = new ActionListener() {
                                  public void actionPerformed(ActionEvent e) {
                                      setVisible(false);
                                  }
                              };
        ...
        sliderwinsize.setToolTipText("<html>Window Length for one Step<br>Larger Windows have worse<br>Frequency Resolution, vice versa");
        ...
        sliderwinfunktion.setToolTipText("<html>Select the Window Function multiplied<br>with the sample window");
        ...
        csspecwhileplaying.setToolTipText("<html>Show the Spectrum in the single<br>Frequency Curve while playing<br>(Shown in the right Area)");
        ...
        cscolsi.setToolTipText("<html>Do not show amplitude<br>based colors in single Frequency view<br>(Shown in the right Area)");
        p.add(cscolsi);
        cback = new JCheckBox ("Normalize Single Curve",sono.inorsi);
        cback.setForeground(new Color(0,51,180));
        cback.setToolTipText("<html>Normalize single frequency view to<br>max amplitude (Shown in the right Area)");
        p.add(cback);
        ...
        csavehist.setToolTipText("<html>Save the File Hotlist for the<br>last opened Filenames every<br>time Sonogram terminated");
        p.add(csavehist);
        ...
        csavescreepos.setToolTipText("<html><b>Remember Screen Positions</b><br>Save the screen positions and dimension<br>for all windows, every time Sonogram terminated.<br>Next time you start Sonogram it will place<br>the windows at hte same locations.");
        p.add(csavescreepos);
        ...
        cssaveconf.setToolTipText("<html><b>Save Configuration</b><br>Save the Configuration to a XML file<br>each time Sonogram terminates. Disable<br>this if you which that Sonogram should<br>open always with the initial settings");
        p.add(cssaveconf);
        ...
        csopenlast.setToolTipText("<html><b>Auto Open last File</b><br>Sonogram then opens automatically the last<br>open File, next time it will starting up.");
        p.add(csopenlast);
        ...
        copenlastwithzoom.setToolTipText("<html><b>Open Last File with Zoom</b><br>If this flag is selected, the automatically opened File<br>will be zoomed with the last zoom factor.");
        ...
        csampl.setToolTipText("<html><b>Open with 8Khz Samplerate</b><br>The open File will be reopened with<br>a downsampled sampling frequency of 8kHz");
        p.add(csampl);
        cgrid     = new JCheckBox ("Show the Grid in the Sonogram",sono.igrid);
	sono.gridItem.setState(sono.igrid);
        cgrid.setToolTipText("<html>Enables/Disabled the <b>time and frequency grid</b><br>in the Sonogram main window");
        p.add(cgrid);
        cenergy   = new JCheckBox ("Show Energy Intensivity",sono.ienergy);
        cenergy.setToolTipText("<html>Shows the Shorttime-Energy instead of the<br>Aplitude the the Timeline");
        p.add(cenergy);
        ...
        sliderwinspeed.setToolTipText("<html>Influences how mutch transformations generated<br>per window in the Sonogram");
        ...
        cuniverse.setToolTipText("<html>The Background Spehere of the Plot is textured<br>with an starfied picture.<br><i>A kind of EASTER EGG</i>");
        ps.add(cuniverse);
        cscrennsaver    = new JCheckBox ("Rotation",sono.irotate);
        cscrennsaver.setToolTipText("<html>Rotates the Perspectogram if<br>ten seconds nothing happens<b>");
        ps.add(cscrennsaver);
        cperantialias    = new JCheckBox ("Antialiasing",sono.iperantialias);
        cperantialias.setToolTipText("<html>Antialiased Perspectogram Model<br><b>Decreases Plot Performance !!!<b>");
        ...
        cb.setForeground(new Color(255-bgcol.getRed(),255-bgcol.getGreen(),255-bgcol.getBlue()));
        ActionListener colst = new ActionListener() {
                                   public void actionPerformed(ActionEvent e) {
        ...
        slidersurface.setToolTipText("<html>Point Reduction for mass data in<br>the Perspectogram. Very usefully<br>for large Point Clouds<br><b>ALPHA VERSION<b>");
        ...
        sliderformant.setToolTipText("<html>Frequency Division reduces the maximal<br>displayed frequency in the FFT analyzer window");
        ...
        sliderlpcfftnum.setToolTipText("<html>Number of Transformation Points used<br>for the FFT in the LPC");
        ...
        clfor.setToolTipText("Search for peak points int the LPC spectrum which<br>are called formants in the speech");
        pl1.add(clfor);
        ...
        if (sono.iffttrans == false) {
            ...
            sliderlpcsamfutur.setBorder(BorderFactory.createTitledBorder(redlineborder, "Prediction Buffer"));
        }
        ...
        cplimitfr.setToolTipText("<html>Remove all the Pitches which<br>appear to lay in in <b>Silent</b> areas"); 
	ppg.add(cplimitfr);
        cpraway = new JCheckBox ("Remove Runaways",sono.ipraway);
        cpraway.setToolTipText("<html>Remove Pitch Points don't<br><b>Match the Curve</b> or lay in <br><b>Silent</b> areas");
        ppg.add(cpraway);
        cptrack = new JCheckBox ("Track Pitch",sono.iptrack);
        cptrack.setToolTipText("<html>Track Pitch while <b>move the Mouse</b><br>over the pitch or the main window");
	ppg.add(cptrack);
	...
	ps.setLayout(new GridLayout(1,2));
        ...
        sliderpwinshift.setToolTipText("<html>The length of the <b>Inner Summarization Loop</b><br>of the Autocorrelation Algorithm for the Window");
	...
	p1.addTab("AC Based Pitch Estimation",new ImageIcon(Sonogram.class.getResource("small_pitch.gif")),p);
        ...
        slideracwinlength.setBorder(new TitledBorder(new EtchedBorder(),"Autocorrelation Window Length"));
        ...
        slideracwinshift.setBorder(new TitledBorder(new EtchedBorder(),"Autocorrelation Loop Length (ms)"));
        slideracwinshift.setToolTipText("<html>The length of the <b>Inner Summarization Loop</b><br>of the Autocorrelation Algorithm for the Window");
        ...
        pwa.setBorder(new TitledBorder(new EtchedBorder(),"General Waveform settings for the Waveform Display"));
        ...
        cwfnorm.setToolTipText("<htmnl><b>Normalizes the Waveform Amplitude</b><br>to the maximum hight of the Window");
        pwa.add(cwfnorm);
        p.add(pwa);
        ...
        sliderwave.setBorder(new TitledBorder(new EtchedBorder(),"Time Span displayed in the Waveform"));
        ...
        rfft = new JRadioButton("<html><b><font size=6>FFT</font></b> - Use Fast Fourier Transform Algorithm for the generation of the main Sonogram",true);
        rfft.setToolTipText("Use FFT for the main display");
        group2.add(rfft);
        p.add(rfft);
        rlpc = new JRadioButton("<html><b><font size=6>LPC</font></b> - Use Linear Prediction Coefficient Algorithm for the generation of the main Sonogram<br><font size=-2 color=#000066><i>Use the LPC settings pannel for the algorithm prarametrization");
        rlpc.setToolTipText("<html>Use LPC for the main display <b>BETA !!!</b><br>Use the LPC settings pannel to trim the<br>algorithm parameters.");
        group2.add(rlpc);
        p.add(rlpc);
        p1.addTab("Transformation",new ImageIcon(Sonogram.class.getResource("tra.gif")),p);
        if (sono.iffttrans == true)
            rfft.setSelected(true);
        else
            rlpc.setSelected(true);
        ...
        sliderpitch.setBorder(new TitledBorder(new EtchedBorder(),"Frequency Limit for Pitch Detection"));
        p.add(sliderpitch);
        ...
        p = new JPanel();
        p.setLayout(new GridLayout(2,1));
        p.setBorder(new TitledBorder(new EtchedBorder(),"Display Amplitude Energy in Logarithm Scale"));
        JPanel plo1 = new JPanel();
        plo1.setLayout(new GridLayout(3,2));
        plo1.setBorder(new TitledBorder(new EtchedBorder(),"General Logarithm Amplitude Scale Settings"));
        ...
        sliderlog.setBorder(new TitledBorder(new EtchedBorder(),"Scale Trimming for Logarithm Amplitude"));
        ...
        if (clog.isSelected()==false)
            sliderlog.setEnabled(false);

        // Logarithm Frequency
        p = new JPanel();
        p.setLayout(new GridBagLayout());
        p.setBorder(new TitledBorder(new EtchedBorder(),"Display the Frequency Axis in Logarithm Scale"));
        ...
        cslogfr.setToolTipText("<html>A <b>logarithmic scale</b> is a scale of measurement<br>that uses the logarithm of a physical quantity<br>instead of the quantity itself. The frequency<br>scale will be divided into decades. <b>CTRL-L</b>");
				GridBagConstraints c = new GridBagConstraints();c.ipadx=120;c.gridy = 0;
			  p.add(plof1,c);
        plof1.add(cslogfr);
        ...
        cgrid2.setToolTipText("<html>Enables the Grid in the Sonogram main Window <b>CTRL-G</b>");
   			c = new GridBagConstraints();c.ipadx=120;c.gridy = 1;
			  p.add(cgrid2,c);		
		    plof1.add(cgrid2);
        ctooltip = new JCheckBox ("Live Value Window", sono.itooltip);
        ctooltip.setToolTipText("<html><b>The Live-Value-Window</b><br>The live values information window shows<br>detailed information about the spectrum values<br>under the mouse arrow in the main window,<br>and is updated if the mouse is moved.");
				c = new GridBagConstraints();c.ipadx=120;c.gridy = 2;
				p.add(ctooltip,c);
        plof1.add(ctooltip);
        ...
        imgLog = new JLabel(new ImageIcon(Sonogram.class.getResource("imgLog.png")));
				if (marklogfr == true){imgLog.setEnabled(true);imgLin.setEnabled(false);}
				else {imgLog.setEnabled(false);imgLin.setEnabled(true);}
   			c = new GridBagConstraints();c.ipadx=88;;c.ipady=5;c.gridy = 3;
 				p.add(plof2,c);
				plof2.add(imgLin);
				plof2.add(imgLog);
        p1.addTab("Logarithm Frequency",new ImageIcon(Sonogram.class.getResource("small_logfr.gif")),p);
    ...
    public void aktualize() {
        ...
        if (inv == true)
            cinv.setSelected(true);
        else
            cinv.setSelected(false);
        if (grid == true) {
    ...
    private void getOptionsFormMainWin() {
        if (sono.rectItem.isSelected())
            winfunktion = 1;
	      if (sono.blaItem.isSelected())
	          winfunktion = 2;
	      if (sono.triItem.isSelected())
	          winfunktion = 3;
        if (sono.hamItem.isSelected())
            winfunktion = 4;
 	      if (sono.welItem.isSelected())
				    winfunktion = 5;
			  if (sono.gauItem.isSelected())
				    winfunktion = 6;
		    if (sono.hanItem.isSelected())
	          winfunktion = 7;
			  if (sono.flaItem.isSelected())
		        winfunktion = 8;
			  if (sono.harItem.isSelected())
				    winfunktion = 9;
				if (sono.harItem.isSelected())
					  winfunktion = 10;
        if (sono.fireItem.isSelected())
            color       = 1;
        if (sono.colItem.isSelected())
            color       = 2;
        if (sono.rainItem.isSelected())
            color       = 3;
        if (sono.greenItem.isSelected())
            color       = 4;
        if (sono.bwItem.isSelected())
            color       = 5;
        if (sono.gridItem.isSelected())
            grid        = true;
        else
            grid = false;
        if (sono.negItem.isSelected())
            inv         = true;
        else
            inv  = false;
        if (sono.logItem.isSelected())
            log         = true;
        else
            log  = false;
    }
    ...
    public void applyChanges () {
	      ...
	      if (winfunktion == 1)
	          sono.rectItem.setSelected(true);
        if (winfunktion == 2)
            sono.blaItem.setSelected(true);
	      if (winfunktion == 3)
	          sono.triItem.setSelected(true);
	      if (winfunktion == 4)
	          sono.hamItem.setSelected(true);
        if (winfunktion == 5)
            sono.welItem.setSelected(true);
        if (winfunktion == 6)
            sono.gauItem.setSelected(true);
	      if (winfunktion == 7)
	          sono.hanItem.setSelected(true);
			  if (winfunktion == 8)
			      sono.flaItem.setSelected(true);
				if (winfunktion == 9)
				    sono.harItem.setSelected(true);
				if (winfunktion == 10)
						sono.cosItem.setSelected(true);
			  if (winfunktion == 11)
					  sono.asyItem.setSelected(true);

        if (clog.isSelected() == true)
            sono.logItem.setSelected(true);
        else
            sono.logItem.setSelected(false);
        if (cinv.isSelected() == true)
            sono.negItem.setSelected(true);
        else
            sono.negItem.setSelected(false);
        if (cgrid.isSelected())
            sono.gridItem.setSelected(true);
        else
            sono.gridItem.setSelected(false);
        if (cslogfr.isSelected())
            sono.logfrItem.setSelected(true);
        else
            sono.logfrItem.setSelected(false);
    ...
    class DialogListener implements ChangeListener, ActionListener {
		...
		cpfog.setEnabled(cptrack.isSelected());
            ...
            if (e.getSource()==cppoints || e.getSource()==sliderpitchmax || e.getSource() == cptrack || e.getSource() == cpfog) {
                sono.pv.update();
                sono.infod.update();
            }
            if (e.getSource()==sliderpwinlength || e.getSource()==sliderpwinshift || e.getSource()==cpsmooth || e.getSource()==cpraway || e.getSource()==cplimitfr) {
                sono.pv.calculatePitchesWithoutCheck();
                sono.infod.update();
            }
            if (e.getSource() == cacpoints || e.getSource() == slideracwinshift || e.getSource() == slideracwinlength || e.getSource() == cacpitch || e.getSource() == cacsmooth) {
            ...
            if (e.getSource() == sliderwinsize)
                highLightButton(2);
            if (e.getSource() == sliderlog)
                if(clog.isEnabled() == true)
                    highLightButton(2);
            ...
            if (e.getSource() == sliderwinspeed) {
                if (coverlapping.isEnabled() == true)
                    highLightButton(2);
                if (sliderwinspeed.getValue() == 0)
                    sliderwinspeed.setValue(1);
            }
            if (e.getSource() == slidersurface) {
                if (slidersurface.getValue() == 0)
                    slidersurface.setValue(1);
            }
            ...
            if (e.getSource()==sliderlpcfftnum || e.getSource()==sliderlpccoef
                    || e.getSource()==sliderlpcsamfutur || e.getSource()==sliderlpcfre
                    || e.getSource()==cllog || e.getSource()==clfor ) {
                if (sliderlpccoef.getValue()<2)
                    sliderlpccoef.setValue(2);
                if (sliderlpcsamfutur.getValue()<70)
                    sliderlpcsamfutur.setValue(70);
                tf1.setText("LPC Coefficients: " + java.lang.Integer.toString(sliderlpccoef.getValue()));
                tf2.setText("Previous Samples: " + java.lang.Integer.toString(sliderlpcsamfutur.getValue()));
                sono.lv.update();
                sono.infod.update();
            }
            ...
            if (e.getSource() == csmooth) {            // Smooth-Checker Y Event
					    if (csmooth.isSelected() == true)
						    sono.smoothfrbutton.setBorder(BorderFactory.createLoweredBevelBorder());
							  ...
							  if (sono.fullbutton != null) // prevents error wen fullbutto is not instanciated while startup
            ...
            if (e.getSource() == csmoothx) 
						{            // Smooth-Checker X Event
            ...
            if (e.getSource()==rfft || e.getSource()==rlpc) {              // Transformation Select
                ...
                if (rfft.isSelected()!=marktrans && sono.spektrumExist==true) {
                    marktrans = rfft.isSelected();
                    if (rfft.isSelected()==true)
                        System.out.println("--> FFT Transformation Selected.");
                    else
                        System.out.println("--> LPC Transformation Selected");
                    sono.readerIsBack();
                    if (rlpc.isSelected() == true) {
                        p1.setSelectedIndex(7);
                        sono.messageBox("Information","For better views with LPC Transformation\nuse a greater scale for logarithm amlitude\nand a large number of LPC Coefficients.",1);
                    }
                }
            }
            if (e.getSource() == r0 || e.getSource() == r1 || e.getSource() == r2 || e.getSource() == r3 || e.getSource() == r4 || e.getSource() == r5) {
                applyChanges();
                if (markcolor != color) {
                    repaint();
                    markcolor = color;
                ...
                if (marklogfr != cslogfr.isSelected()) {
                    ...
                    sono.logfrItem.setSelected(marklogfr);
									  if (sono.logfrItem.isSelected() == true)
									    ...
									    sono.logbutton.setBorder(sono.fullbutton.getBorder());
                    //cgrid2.setEnabled(marklogfr);
                    sono.updateimageflag = true;
                    sono.repaint();
                }
            }
            if (e.getSource() == slidersurfacex || e.getSource() == slidersurfacey
                    || e.getSource() == sliderpitch || e.getSource() == s1
                    || e.getSource() == s2 || e.getSource() == s3 || e.getSource() == sliderwinfunktion) {
                if (slidersurfacex.getValue() == 0)
                    slidersurfacex.setValue(1);
                if (slidersurfacey.getValue() == 0)
                    slidersurfacey.setValue(1);
                sono.infod.update();
            }
            ...
            if (e.getSource()==sliderdb) {
                if (sono.player.gain != null)
                    sono.player.gain.setDB((float)sliderdb.getValue());
            }
            if (e.getSource()==cmute) {
                if (sono.player != null)
                    sono.player.gain.setMute(cmute.isSelected());
            }
		...
		sono.irotate = cscrennsaver.isSelected();
            ...
            {
		          if (cperantialias.isSelected()==true && cperantialiaslast == false && cperantialiasconfirm == false) 
		          {
		            JCheckBox askAgain = new JCheckBox("<html><i><font size = -2>Do not show this warning message again");
                Object[] message = new Object[2];
                message[0] = "<html>Antialiasing with Java3D <u><font COLOR=#660000>decreases the Graphic Performace<br>dramatically"+
                             "</u> and is not supported on all Operating Systems.<br><br><font size=4>Enable the Java3D Antialiasing ?";
                message[1] = askAgain;
                int confirm = JOptionPane.showConfirmDialog(
                  ...
                  cperantialias.setSelected(true);
    		        ...
    		        if (confirm == JOptionPane.YES_OPTION)
    		        {
    		          ...
    		          cperantialias.setSelected(false);
		          }
    ...
    public void highLightButton(int highlighted) {
        /** 
          * 0 = Reset all buttons to default.
          * 1 = Set redraw button RED
        	* 2 = Set redcalculate button RED
        	* 3 = Set redopen button RED ´
          */

        if (sono.spektrumExist == false)
            highlighted = 0;
        if (highlighted == 0)
				{
    ...
    class wfPanel extends JPanel {
        ...
        public void paintComponent(Graphics g1) {
           /**
            * this inner class paint windowfunktion on
            * on Window-Funktion Tab
            */
            ...
            for (int y=25;y<height-10;y+=5)
              g.drawLine(10,y,width-11,y);
            for (int x=10;x<width-11;x+=5)
              g.drawLine(x,25,x,height-11);
						// red lines
    ...
    class waPanel extends JPanel {
        ...
        public void paintComponent(Graphics g1) {
            ...
            for (int x=15;x<width-11;x+=4)
              g.drawLine(x,25,x,height-11);
            for (int y=25;y<height-10;y+=4)
              g.drawLine(10,y,width-11,y);
            ...
            for (int count=0;count<size;count++) {
                if (minpeak>ausgang[count])
                    minpeak=ausgang[count];
                if (maxpeak<ausgang[count])
                    maxpeak=ausgang[count];
            }
            peak = maxpeak;
            if ((minpeak+maxpeak) < 0)
                peak = -minpeak;
